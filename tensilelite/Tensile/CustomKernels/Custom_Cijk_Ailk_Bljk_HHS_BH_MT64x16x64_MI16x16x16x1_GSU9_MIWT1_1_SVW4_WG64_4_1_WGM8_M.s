...
.text
.protected Custom_Cijk_Ailk_Bljk_HHS_BH_MT64x16x64_MI16x16x16x1_GSU9_MIWT1_1_SVW4_WG64_4_1_WGM8_M
.globl Custom_Cijk_Ailk_Bljk_HHS_BH_MT64x16x64_MI16x16x16x1_GSU9_MIWT1_1_SVW4_WG64_4_1_WGM8_M
.p2align 8
.type Custom_Cijk_Ailk_Bljk_HHS_BH_MT64x16x64_MI16x16x16x1_GSU9_MIWT1_1_SVW4_WG64_4_1_WGM8_M,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Custom_Cijk_Ailk_Bljk_HHS_BH_MT64x16x64_MI16x16x16x1_GSU9_MIWT1_1_SVW4_WG64_4_1_WGM8_M
...
amdhsa.version:
  ...
  - 0
amdhsa.kernels:
  - .name: Custom_Cijk_Ailk_Bljk_HHS_BH_MT64x16x64_MI16x16x16x1_GSU9_MIWT1_1_SVW4_WG64_4_1_WGM8_M
    .symbol: 'Custom_Cijk_Ailk_Bljk_HHS_BH_MT64x16x64_MI16x16x16x1_GSU9_MIWT1_1_SVW4_WG64_4_1_WGM8_M.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Custom_Cijk_Ailk_Bljk_HHS_BH_MT64x16x64_MI16x16x16x1_GSU9_MIWT1_1_SVW4_WG64_4_1_WGM8_M:
...
buffer_load_dwordx2 v[vgprG2LB+0:vgprG2LB+0+1], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0, glc slc // G -> Reg 0_0_0_0
...
s_waitcnt vmcnt(2)                                 // wait for global read before writing to local
ds_write_b128 v[vgprLocalWriteAddrA], v[vgprG2LA+4:vgprG2LA+4+3] offset:4096 // lwoA_0_0_1_0 = (0*LSCA) + (1*LSPA)(*MT0I+PAD) = 4096
buffer_load_dwordx4 v[vgprG2LA+4:vgprG2LA+4+3], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+0] offen offset:0, glc slc // G -> Reg 0_0_1_0, glc slc
/* sched write - iter 0 writesPerItem=1 */
s_waitcnt vmcnt(2)                                 // wait for global read before writing to local
ds_write_b64 v[vgprLocalWriteAddrB], v[vgprG2LB+0:vgprG2LB+0+1] offset:0 // lwoB_0_0_0_0 = (0*LSCB)*(MT1J+PAD) + (0*LSPB) = 0
buffer_load_dwordx2 v[vgprG2LB+0:vgprG2LB+0+1], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0, glc slc // G -> Reg 0_0_0_0
...
buffer_load_short_d16_hi v33, v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], 0 offen offset:6, glc slc // load one buffer value
s_waitcnt vmcnt(0)
...
buffer_load_short_d16_hi v33, v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], 0 offen offset:10, glc slc // load one buffer value
s_waitcnt vmcnt(0)
...
buffer_load_short_d16_hi v33, v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], 0 offen offset:14, glc slc // load one buffer value
s_waitcnt vmcnt(0)
...
buffer_load_short_d16_hi v33, v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+0] offen offset:6, glc slc // load one buffer value
s_waitcnt vmcnt(0)
...
buffer_load_short_d16_hi v33, v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+0] offen offset:10, glc slc // load one buffer value
s_waitcnt vmcnt(0)
...
buffer_load_short_d16_hi v33, v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+0] offen offset:14, glc slc // load one buffer value
s_waitcnt vmcnt(0)
...
/* g2l=0, load component 3 */
buffer_load_short_d16_hi v33, v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0 offen offset:6, glc slc // load one buffer value
s_waitcnt vmcnt(0)
