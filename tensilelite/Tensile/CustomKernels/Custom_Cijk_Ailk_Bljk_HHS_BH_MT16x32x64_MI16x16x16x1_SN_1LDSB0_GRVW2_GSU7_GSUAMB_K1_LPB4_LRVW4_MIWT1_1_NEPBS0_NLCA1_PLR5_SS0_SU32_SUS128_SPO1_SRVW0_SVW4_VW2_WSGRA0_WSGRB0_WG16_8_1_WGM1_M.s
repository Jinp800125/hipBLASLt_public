...
.text
.protected Custom_Cijk_Ailk_Bljk_HHS_BH_MT16x32x64_MI16x16x16x1_SN_1LDSB0_GRVW2_GSU7_GSUAMB_K1_LPB4_LRVW4_MIWT1_1_NEPBS0_NLCA1_PLR5_SS0_SU32_SUS128_SPO1_SRVW0_SVW4_VW2_WSGRA0_WSGRB0_WG16_8_1_WGM1_M
.globl Custom_Cijk_Ailk_Bljk_HHS_BH_MT16x32x64_MI16x16x16x1_SN_1LDSB0_GRVW2_GSU7_GSUAMB_K1_LPB4_LRVW4_MIWT1_1_NEPBS0_NLCA1_PLR5_SS0_SU32_SUS128_SPO1_SRVW0_SVW4_VW2_WSGRA0_WSGRB0_WG16_8_1_WGM1_M
.p2align 8
.type Custom_Cijk_Ailk_Bljk_HHS_BH_MT16x32x64_MI16x16x16x1_SN_1LDSB0_GRVW2_GSU7_GSUAMB_K1_LPB4_LRVW4_MIWT1_1_NEPBS0_NLCA1_PLR5_SS0_SU32_SUS128_SPO1_SRVW0_SVW4_VW2_WSGRA0_WSGRB0_WG16_8_1_WGM1_M,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Custom_Cijk_Ailk_Bljk_HHS_BH_MT16x32x64_MI16x16x16x1_SN_1LDSB0_GRVW2_GSU7_GSUAMB_K1_LPB4_LRVW4_MIWT1_1_NEPBS0_NLCA1_PLR5_SS0_SU32_SUS128_SPO1_SRVW0_SVW4_VW2_WSGRA0_WSGRB0_WG16_8_1_WGM1_M
...
amdhsa.version:
  ...
  - 0
amdhsa.kernels:
  - .name: Custom_Cijk_Ailk_Bljk_HHS_BH_MT16x32x64_MI16x16x16x1_SN_1LDSB0_GRVW2_GSU7_GSUAMB_K1_LPB4_LRVW4_MIWT1_1_NEPBS0_NLCA1_PLR5_SS0_SU32_SUS128_SPO1_SRVW0_SVW4_VW2_WSGRA0_WSGRB0_WG16_8_1_WGM1_M
    .symbol: 'Custom_Cijk_Ailk_Bljk_HHS_BH_MT16x32x64_MI16x16x16x1_SN_1LDSB0_GRVW2_GSU7_GSUAMB_K1_LPB4_LRVW4_MIWT1_1_NEPBS0_NLCA1_PLR5_SS0_SU32_SUS128_SPO1_SRVW0_SVW4_VW2_WSGRA0_WSGRB0_WG16_8_1_WGM1_M.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Custom_Cijk_Ailk_Bljk_HHS_BH_MT16x32x64_MI16x16x16x1_SN_1LDSB0_GRVW2_GSU7_GSUAMB_K1_LPB4_LRVW4_MIWT1_1_NEPBS0_NLCA1_PLR5_SS0_SU32_SUS128_SPO1_SRVW0_SVW4_VW2_WSGRA0_WSGRB0_WG16_8_1_WGM1_M:
...
.set sgprtmp0E, 76//68 not to change spgr num
...
.set sgprSrdtmp, sgprtmp7+1
.set sgprtmp0, sgprSrdDd+4
.set sgprtmp1, sgprtmp0+1
.set sgprtmp2, sgprtmp0+2
.set sgprtmp3, sgprtmp0+3
.set sgprtmp4, sgprtmp0+4
.set sgprtmp5, sgprtmp0+5
.set sgprtmp6, sgprtmp0+6
.set sgprtmp7, sgprtmp0+7
//GSUFusion
...
s_load_dwordx2 s[44:45], s[sgprKernArgAddress:sgprKernArgAddress+1], 0x60
...
s_mov_b32 s73, 0x0                                 // STATIC_DIV: divisior=7
s_mul_i32 s72, 0x4924, s74                         // tmp1 = dividend * magic hi
s_lshl_b64 s[72:73], s[72:73], 0x10                // left shift 16 bits
s_mul_i32 s[sgprWorkGroup1], s74, 0x924a           // tmp0 = dividend * magic lo
...
s_mul_i32 s72, s[sgprWorkGroup1], 0x7              // quotient*divisor
...
buffer_load_dword v[vgprG2LA+0], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], 0 offen offset:0, glc slc // G -> Reg 0_0_0_0
buffer_load_dword v[vgprG2LA+1], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+0] offen offset:0, glc slc // G -> Reg 0_0_1_0
buffer_load_dword v[vgprG2LA+2], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+1] offen offset:0, glc slc // G -> Reg 0_0_2_0
buffer_load_dword v[vgprG2LA+3], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+2] offen offset:0, glc slc // G -> Reg 0_0_3_0
buffer_load_dword v[vgprG2LB+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], 0 offen offset:0, glc slc // G -> Reg 0_0_0_0
buffer_load_dword v[vgprG2LB+1], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+0] offen offset:0, glc slc // G -> Reg 0_0_1_0
buffer_load_dword v[vgprG2LB+2], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+1] offen offset:0, glc slc // G -> Reg 0_0_2_0
buffer_load_dword v[vgprG2LB+3], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+2] offen offset:0, glc slc // G -> Reg 0_0_3_0
buffer_load_dword v[vgprG2LB+4], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+3] offen offset:0, glc slc // G -> Reg 0_0_4_0
buffer_load_dword v[vgprG2LB+5], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+4] offen offset:0, glc slc // G -> Reg 0_0_5_0
buffer_load_dword v[vgprG2LB+6], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+5] offen offset:0, glc slc // G -> Reg 0_0_6_0
buffer_load_dword v[vgprG2LB+7], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+6] offen offset:0, glc slc // G -> Reg 0_0_7_0
...
//s_lshr_b64 s[sgprSrdC+0:sgprSrdC+1], s[sgprSrdC+0:sgprSrdC+1], 1                   // scale by bpe
...
s_cbranch_scc0 label_NoBranch_Y8K30VFKZLNIO8PO_0   // Only branch on scc1
...
label_NoBranch_Y8K30VFKZLNIO8PO_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read
...
buffer_load_short_d16 v[vgprG2LA+1+0], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+0] offen offset:0, glc slc // load one buffer value
...
buffer_load_short_d16 v[vgprG2LA+2+0], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+1] offen offset:0, glc slc // load one buffer value
...
buffer_load_short_d16 v[vgprG2LA+3+0], v[vgprGlobalReadOffsetA+0], s[sgprSrdA:sgprSrdA+3], s[sgprScalarGlobalReadOffsetA+2] offen offset:0, glc slc // load one buffer value
...
/* g2l=1, load component 0 */
buffer_load_short_d16 v[vgprG2LB+1+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+0] offen offset:0, glc slc // load one buffer value
/* g2l=1, load component 1 */
buffer_load_short_d16_hi v35, v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+0] offen offset:2, glc slc // load one buffer value
s_waitcnt vmcnt(0)
v_or_b32 v[vgprG2LB+1+0], v[vgprG2LB+1+0], v35     // HasEccHalf: pack
/* g2l=2, load component 0 */
buffer_load_short_d16 v[vgprG2LB+2+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+1] offen offset:0, glc slc // load one buffer value
/* g2l=2, load component 1 */
buffer_load_short_d16_hi v35, v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+1] offen offset:2, glc slc // load one buffer value
s_waitcnt vmcnt(0)
v_or_b32 v[vgprG2LB+2+0], v[vgprG2LB+2+0], v35     // HasEccHalf: pack
/* g2l=3, load component 0 */
buffer_load_short_d16 v[vgprG2LB+3+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+2] offen offset:0, glc slc // load one buffer value
/* g2l=3, load component 1 */
buffer_load_short_d16_hi v35, v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+2] offen offset:2, glc slc // load one buffer value
s_waitcnt vmcnt(0)
v_or_b32 v[vgprG2LB+3+0], v[vgprG2LB+3+0], v35     // HasEccHalf: pack
/* g2l=4, load component 0 */
buffer_load_short_d16 v[vgprG2LB+4+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+3] offen offset:0, glc slc // load one buffer value
/* g2l=4, load component 1 */
buffer_load_short_d16_hi v35, v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+3] offen offset:2, glc slc // load one buffer value
s_waitcnt vmcnt(0)
v_or_b32 v[vgprG2LB+4+0], v[vgprG2LB+4+0], v35     // HasEccHalf: pack
/* g2l=5, load component 0 */
buffer_load_short_d16 v[vgprG2LB+5+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+4] offen offset:0, glc slc // load one buffer value
/* g2l=5, load component 1 */
buffer_load_short_d16_hi v35, v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+4] offen offset:2, glc slc // load one buffer value
s_waitcnt vmcnt(0)
v_or_b32 v[vgprG2LB+5+0], v[vgprG2LB+5+0], v35     // HasEccHalf: pack
/* g2l=6, load component 0 */
buffer_load_short_d16 v[vgprG2LB+6+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+5] offen offset:0, glc slc // load one buffer value
/* g2l=6, load component 1 */
buffer_load_short_d16_hi v35, v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+5] offen offset:2, glc slc // load one buffer value
s_waitcnt vmcnt(0)
v_or_b32 v[vgprG2LB+6+0], v[vgprG2LB+6+0], v35     // HasEccHalf: pack
/* g2l=7, load component 0 */
buffer_load_short_d16 v[vgprG2LB+7+0], v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+6] offen offset:0, glc slc // load one buffer value
/* g2l=7, load component 1 */
buffer_load_short_d16_hi v35, v[vgprGlobalReadOffsetB+0], s[sgprSrdB:sgprSrdB+3], s[sgprScalarGlobalReadOffsetB+6] offen offset:2, glc slc // load one buffer value
s_waitcnt vmcnt(0)
...
v_add_co_u32 v[vgprLocalReadAddrA], vcc, s72, v[vgprLocalReadAddrA] // lrA += 512 (LSU*(MT+PAD)*bpe)
...
v_cmp_ge_i32 s[72:73], v35, s[sgprLoopCounterL]    // check K index >= Size L
...
v_cmp_lt_i32 s[72:73], v35, 4                      // set partial 0 if distance less than input per thread
...
v_lshlrev_b64 v[36:37], s74, v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0+0], v[vgprValuA_X0_I0+0+0+0+0], v36, s[72:73]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0+1], v[vgprValuA_X0_I0+0+0+0+1], v37, s[72:73]
v_lshlrev_b64 v[36:37], s74, v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+0], v[vgprValuB_X0_I0+0+0+0+0], v36, s[72:73]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+1], v[vgprValuB_X0_I0+0+0+0+1], v37, s[72:73]
s_nop 1
v_mfma_f32_16x16x16f16 acc[0:3], v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1], v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1], acc[0:3] // left value = acc[0+0:3+0]
...
label_TailLoopEndL:
label_SkipTailLoopL:
label_Summation_End_4P76ROVHXAQ8U6J0_0:
s_setprio 0                                        // optimization store
...
s_mul_i32 s46, 32, s[sgprWorkGroup1]               // wgp1 * MT1
...
s_and_b32 s46, 31, s[sgprSizeJ]                    // s46 = s[sgprSizeJ] % 32
...
s_cmp_ge_u32 s[sgprtmp0E], 574                    // Beta == 0
