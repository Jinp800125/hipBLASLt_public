...
.text
.protected Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_AH_SDV_MT32x16x64_MI16x16x16x1_SN_K1_MIWT1_1
.globl Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_AH_SDV_MT32x16x64_MI16x16x16x1_SN_K1_MIWT1_1
.p2align 8
.type Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_AH_SDV_MT32x16x64_MI16x16x16x1_SN_K1_MIWT1_1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_AH_SDV_MT32x16x64_MI16x16x16x1_SN_K1_MIWT1_1
...
amdhsa.version:
  ...
  - 0
amdhsa.kernels:
  - .name: Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_AH_SDV_MT32x16x64_MI16x16x16x1_SN_K1_MIWT1_1
    .symbol: 'Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_AH_SDV_MT32x16x64_MI16x16x16x1_SN_K1_MIWT1_1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_AH_SDV_MT32x16x64_MI16x16x16x1_SN_K1_MIWT1_1:
...
s_cbranch_scc0 label_NoBranch_UWTYBTG853BQH490_0   // Only branch on scc1
...
label_NoBranch_UWTYBTG853BQH490_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read
...
s_mul_i32 s54, 32, s[sgprWorkGroup0]               // wgp0 * MT0
...
v_mul_lo_u32 v35, s65, v35                         // LSU offset: lsuoffset = sgid*(MT0+PAD)
...
v_mul_lo_u32 v35, s65, v35                         // LSU offset: lsuoffset = sgid*(MT1+PAD)
...
/* local read inc a */
s_mov_b32 s65, 0x400                               // inc
v_add_co_u32 v[vgprLocalReadAddrA], vcc, s65, v[vgprLocalReadAddrA] // lrA += 1024 (LSU*(MT+PAD)*bpe)
...
label_TailLoopEndL:
label_SkipTailLoopL:
label_Summation_End_0A7L94XD28FPP0GJ_0:
s_setprio 0                                        // optimization store
/* endSummation: add vgpr [0...32) to pool */
.set ShadowLimitB, UNDEF
.set SrdA, UNDEF
...
//Victor                                       // wait for ScaleDVec, Bias LDS
...
v_cmp_ge_f32 vcc, v[vgprValuC+30], s[sgpractivationAlpha] // x >= alpha ?
...
v_cmp_ge_f32 vcc, v[vgprValuC+31], s[sgpractivationAlpha] // x >= alpha ?
...
s_atomic_add s[sgprtmp0E], s[sgprKernArgAddress:sgprKernArgAddress+1], 0x6c glc
...
buffer_load_dwordx4 v[20+4*0:23+4*0], v9, s[sgprSrdDd:sgprSrdDd+3], 0 offen offset:0 // store D
...
s_add_u32 s[sgprSrdDd+0], s[sgprSrdD+0], s[sgprtmp0E]        // add lo GSU offset to SRD
s_addc_u32 s[sgprSrdDd+1], s[sgprSrdD+1], s[sgprtmp1E]       // add hi GSU offset to SRD
buffer_load_dwordx4 v[20+4*1:23+4*1], v9, s[sgprSrdDd:sgprSrdDd+3], 0 offen offset:0 // store D
...
s_add_u32 s[sgprSrdDd+0], s[sgprSrdD+0], s[sgprtmp0E]        // add lo GSU offset to SRD
s_addc_u32 s[sgprSrdDd+1], s[sgprSrdD+1], s[sgprtmp1E]       // add hi GSU offset to SRD
buffer_load_dwordx4 v[20+4*2:23+4*2], v9, s[sgprSrdDd:sgprSrdDd+3], 0 offen offset:0 // store D
...
s_add_u32 s[sgprSrdDd+0], s[sgprSrdD+0], s[sgprtmp0E]        // add lo GSU offset to SRD
s_addc_u32 s[sgprSrdDd+1], s[sgprSrdD+1], s[sgprtmp1E]       // add hi GSU offset to SRD
buffer_load_dwordx4 v[20+4*3:23+4*3], v9, s[sgprSrdDd:sgprSrdDd+3], 0 offen offset:0 // store D
...
s_add_u32 s[sgprSrdDd+0], s[sgprSrdD+0], s[sgprtmp0E]        // add lo GSU offset to SRD
s_addc_u32 s[sgprSrdDd+1], s[sgprSrdD+1], s[sgprtmp1E]       // add hi GSU offset to SRD
buffer_load_dwordx4 v[20+4*4:23+4*4], v9, s[sgprSrdDd:sgprSrdDd+3], 0 offen offset:0 // store D
...
s_add_u32 s[sgprSrdDd+0], s[sgprSrdD+0], s[sgprtmp0E]        // add lo GSU offset to SRD
s_addc_u32 s[sgprSrdDd+1], s[sgprSrdD+1], s[sgprtmp1E]       // add hi GSU offset to SRD
buffer_load_dwordx4 v[20+4*5:23+4*5], v9, s[sgprSrdDd:sgprSrdDd+3], 0 offen offset:0 // store D

s_waitcnt vmcnt(4)
//v_add_F32 v20, v20, v[20+4*1]
//v_add_F32 v21, v21, v[21+4*1]
//v_add_F32 v22, v22, v[22+4*1]
//v_add_F32 v23, v23, v[23+4*1]

V_PK_ADD_F32 v[20:21], v[20:21], v[20+4*1+0:20+4*1+1]
V_PK_ADD_F32 v[22:23], v[22:23], v[20+4*1+2:20+4*1+3]

s_waitcnt vmcnt(3)
//v_add_F32 v20, v20, v[20+4*2]
//v_add_F32 v21, v21, v[21+4*2]
//v_add_F32 v22, v22, v[22+4*2]
//v_add_F32 v23, v23, v[23+4*2]

V_PK_ADD_F32 v[20:21], v[20:21], v[20+4*2+0:20+4*2+1]
V_PK_ADD_F32 v[22:23], v[22:23], v[20+4*2+2:20+4*2+3]

s_waitcnt vmcnt(2)
//v_add_F32 v20, v20, v[20+4*3]
//v_add_F32 v21, v21, v[21+4*3]
//v_add_F32 v22, v22, v[22+4*3]
//v_add_F32 v23, v23, v[23+4*3]

V_PK_ADD_F32 v[20:21], v[20:21], v[20+4*3+0:20+4*3+1]
V_PK_ADD_F32 v[22:23], v[22:23], v[20+4*3+2:20+4*3+3]

s_waitcnt vmcnt(1)
//v_add_F32 v20, v20, v[20+4*4]
//v_add_F32 v21, v21, v[21+4*4]
//v_add_F32 v22, v22, v[22+4*4]
//v_add_F32 v23, v23, v[23+4*4]

V_PK_ADD_F32 v[20:21], v[20:21], v[20+4*4+0:20+4*4+1]
V_PK_ADD_F32 v[22:23], v[22:23], v[20+4*4+2:20+4*4+3]

s_waitcnt vmcnt(0)
//v_add_F32 v20, v20, v[20+4*5]
//v_add_F32 v21, v21, v[21+4*5]
//v_add_F32 v22, v22, v[22+4*5]
//v_add_F32 v23, v23, v[23+4*5]

V_PK_ADD_F32 v[20:21], v[20:21], v[20+4*5+0:20+4*5+1]
V_PK_ADD_F32 v[22:23], v[22:23], v[20+4*5+2:20+4*5+3]

v_mul_f32 v20 v20 s[sgprAlpha]
v_mul_f32 v21 v21 s[sgprAlpha]
v_mul_f32 v22 v22 s[sgprAlpha]
v_mul_f32 v23 v23 s[sgprAlpha]
...
buffer_load_sshort v[32], v9, s[sgprSrdD:sgprSrdD+3], 0 offen offset:0 // store D
buffer_load_sshort v[33], v9, s[sgprSrdD:sgprSrdD+3], 0 offen offset:2 // store D
buffer_load_sshort v[34], v9, s[sgprSrdD:sgprSrdD+3], 0 offen offset:4 // store D
buffer_load_sshort v[35], v9, s[sgprSrdD:sgprSrdD+3], 0 offen offset:6 // store D
...
buffer_store_dwordx2 v[20:21], v9, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // store D
