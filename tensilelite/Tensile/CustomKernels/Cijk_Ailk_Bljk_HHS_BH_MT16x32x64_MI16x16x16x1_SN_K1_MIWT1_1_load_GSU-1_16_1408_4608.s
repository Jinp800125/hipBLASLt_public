...
.text
.protected Cijk_Ailk_Bljk_HHS_BH_MT16x32x64_MI16x16x16x1_SN_K1_MIWT1_1
.globl Cijk_Ailk_Bljk_HHS_BH_MT16x32x64_MI16x16x16x1_SN_K1_MIWT1_1
.p2align 8
.type Cijk_Ailk_Bljk_HHS_BH_MT16x32x64_MI16x16x16x1_SN_K1_MIWT1_1,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Cijk_Ailk_Bljk_HHS_BH_MT16x32x64_MI16x16x16x1_SN_K1_MIWT1_1
...
amdhsa.version:
  ...
  - 0
amdhsa.kernels:
  - .name: Cijk_Ailk_Bljk_HHS_BH_MT16x32x64_MI16x16x16x1_SN_K1_MIWT1_1
    .symbol: 'Cijk_Ailk_Bljk_HHS_BH_MT16x32x64_MI16x16x16x1_SN_K1_MIWT1_1.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Cijk_Ailk_Bljk_HHS_BH_MT16x32x64_MI16x16x16x1_SN_K1_MIWT1_1:
...
.macro GSUSYNC labelname labelendname vgprstart vgprstart1 vgprstart2 vgproffset
    
    v_mov_b32 v[\vgprstart+2] v[\vgprstart1+0]
    v_mov_b32 v[\vgprstart+3] v[\vgprstart1+1]
    ...
    s_mov_b32 s[sgprSrdtmp+0] s[sgprSrdD+0]
    s_mov_b32 s[sgprSrdtmp+1] s[sgprSrdD+1]
    ...
    //s_add_u32 s[sgprGSUSumIdx] s[sgprGSUSumIdx] 1
    //S_MAX_U32 s[sgprtmp1E] s[sgprGSUSumIdx] GSU
    //S_MIN_U32 s[sgprtmp0E] s[sgprGSUSumIdx] GSU
    //s_cmov_b32 s[sgprtmp1E] s[sgprGSUSumIdx]
    //s_cmov_b32 s[sgprtmp0E] 0

    //s_sub_u32 s[sgprGSUSumIdx] s[sgprtmp1E] s[sgprtmp0E]

    //s_mul_hi_u32 s[sgprtmp7E] s[sgprtmp2E] s[sgprGSUSumIdx]            // Free1
    //s_mul_i32 s[sgprtmp6E] s[sgprtmp2E] s[sgprGSUSumIdx]               // Free1
    //s_mul_i32 s[sgprtmp5E] s[sgprtmp3E] s[sgprGSUSumIdx]
    //s_add_u32 s[sgprSrdD+0] s[sgprSrdtmp+0] s[sgprtmp6E]        // add lo GSU offset to SRD
    //s_addc_u32 s[sgprSrdD+1] s[sgprSrdtmp+1] s[sgprtmp7E]       // add hi GSU offset to SRD
    //s_add_u32 s[sgprSrdD+1] s[sgprSrdD+1] s[sgprtmp5E]        // add lo GSU offset to SRD
    ...
    v_mov_b32 v[\vgprstart1+0] v[\vgprstart+2]
    v_mov_b32 v[\vgprstart1+1] v[\vgprstart+3]
.endm
...
.macro GSUSYNCzero
    ...
    s_addc_u32 s[sgprSrdDd+1] s[sgprAddressD+1] s[sgprtmp3E]   // add hi to SRD
        ...
        buffer_store_dword v[0] v0 s[sgprSrdDd:sgprSrdDd+3] 0 offen offset:4*1 // attempt write avi=0
...
s_cbranch_scc0 label_NoBranch_MUTL55M8RZV56YDB_0   // Only branch on scc1
...
label_NoBranch_MUTL55M8RZV56YDB_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read
...
// GSUcloseSumAtLeastUnroll1
/* Stores for OptNLL */
label_Summation_End_P6VJ4ICDQDFFHFHA_0:
s_setprio 0                                        // optimization store
...
GSUSYNC Summation_End_OptNLL, label_KernelEnd, 12, 10, 8, v6
...
label_TailLoopEndL:
// GSUSYNC111111
// GSUSYNC1GSUSYNC1GSUSYNC1
label_SkipTailLoopL:
// GSUSYNC34
label_Summation_End_GUINXVT3SGBKHCL2_0:
s_setprio 0                                        // optimization store
/* endSummation: add vgpr [0...32) to pool */
// GSUendSummation
...
GSUSYNC Summation_End_OptNLL2_3, label_KernelEnd, 12, 10, 8, v6
...
GSUSYNC Summation_End_OptNLL2_2, label_KernelEnd, 12, 10, 8, v6
...
/* (d1,vc1,d0,vc0)=(0,0,0,2) */
// GSUSYNCc3 1
buffer_load_dword v12, v7, s[sgprSrdC:sgprSrdC+3], 0 offen offset:4 // load C
v_add_lshl_u32 v6, v3, v0, 0x2                     // optSingleColVgpr scaleToBpe: sharedAddrVgpr <- cinRowPtr + coord0, scaled by BPE. BSHERE:coord0=0, coord0Vgpr=0
...
buffer_store_dwordx2 v[14:15], v6, s[sgprSrdD:sgprSrdD+3], 0 offen offset:8 // store D
s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst

GSUSYNC0 Summation_End_OptNLL2_1, label_KernelEnd
GSUSYNC Summation_End_OptNLL2_1, label_KernelEnd, 16, 14, 10, v6
...
v_fma_mix_f32 v[vgprValuC+14], s[sgprBeta], v12, v[vgprValuC+14] op_sel:[0,0,0] op_sel_hi:[0,1,0] // //C*=beta
v_fma_mix_f32 v[vgprValuC+15], s[sgprBeta], v12, v[vgprValuC+15] op_sel:[0,1,0] op_sel_hi:[0,1,0] // //C*=beta
//buffer_store_dwordx2 v[14:15], v6, s[sgprSrdD:sgprSrdD+3], 0 offen offset:8 // store D
//s_nop 0                                            // 1 wait state required when next inst writes vgprs held by previous dwordx4 store inst
...
v_cmp_lt_u32 s[52:53], v1, s[sgprSizeJ]            // coord1 < size1
s_and_b64 s[52:53], s[48:49], s[52:53]             // in0 && in1
v_add_lshl_u32 v7, v2, v4, 0x2                     // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
// GSUSYNCc1 0

GSUSYNCc v7

v_cndmask_b32 v7, -1, v7, s[52:53]                 // LDC clip if OOB. offset
// GSUSYNCc3 1
buffer_load_dword v12, v7, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // load C
v_add_lshl_u32 v7, v3, v4, 0x2                     // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v7, -1, v7, s[52:53]                 // LDD clip if OOB. offset
v_accvgpr_read_b32 v[vgprValuC+10], acc0           // copy acc to vreg[0]
v_accvgpr_read_b32 v[vgprValuC+11], acc1           // copy acc to vreg[1]
...
GSUSYNC Summation_End_OptNLL2, label_KernelEnd, 16, 14, 10, v6
