...
.text
.protected Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_AH_SDV_MT16x32x64_MI16x16x16x1_SN_1LDSB0_GRVW2_GSU5_LPA0_LPB4_LRVW4_MIWT1_1_NEPBS0_NLCA1_PLR5_SS0_SU32_SUS128_SPO1_SRVW0_SVW4_VW2_WSGRA0_WSGRB0_WG16_8_1_WGM0
.globl Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_AH_SDV_MT16x32x64_MI16x16x16x1_SN_1LDSB0_GRVW2_GSU5_LPA0_LPB4_LRVW4_MIWT1_1_NEPBS0_NLCA1_PLR5_SS0_SU32_SUS128_SPO1_SRVW0_SVW4_VW2_WSGRA0_WSGRB0_WG16_8_1_WGM0
.p2align 8
.type Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_AH_SDV_MT16x32x64_MI16x16x16x1_SN_1LDSB0_GRVW2_GSU5_LPA0_LPB4_LRVW4_MIWT1_1_NEPBS0_NLCA1_PLR5_SS0_SU32_SUS128_SPO1_SRVW0_SVW4_VW2_WSGRA0_WSGRB0_WG16_8_1_WGM0,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_AH_SDV_MT16x32x64_MI16x16x16x1_SN_1LDSB0_GRVW2_GSU5_LPA0_LPB4_LRVW4_MIWT1_1_NEPBS0_NLCA1_PLR5_SS0_SU32_SUS128_SPO1_SRVW0_SVW4_VW2_WSGRA0_WSGRB0_WG16_8_1_WGM0
...
amdhsa.version:
  ...
  - 0
amdhsa.kernels:
  - .name: Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_AH_SDV_MT16x32x64_MI16x16x16x1_SN_1LDSB0_GRVW2_GSU5_LPA0_LPB4_LRVW4_MIWT1_1_NEPBS0_NLCA1_PLR5_SS0_SU32_SUS128_SPO1_SRVW0_SVW4_VW2_WSGRA0_WSGRB0_WG16_8_1_WGM0
    .symbol: 'Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_AH_SDV_MT16x32x64_MI16x16x16x1_SN_1LDSB0_GRVW2_GSU5_LPA0_LPB4_LRVW4_MIWT1_1_NEPBS0_NLCA1_PLR5_SS0_SU32_SUS128_SPO1_SRVW0_SVW4_VW2_WSGRA0_WSGRB0_WG16_8_1_WGM0.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Custom_Cijk_Ailk_Bljk_HHS_BH_Bias_AH_SDV_MT16x32x64_MI16x16x16x1_SN_1LDSB0_GRVW2_GSU5_LPA0_LPB4_LRVW4_MIWT1_1_NEPBS0_NLCA1_PLR5_SS0_SU32_SUS128_SPO1_SRVW0_SVW4_VW2_WSGRA0_WSGRB0_WG16_8_1_WGM0:
...
s_mov_b32 s82, s[sgprWorkGroup1]                   // copying for divisor
s_mov_b32 s81, 0x0                                 // STATIC_DIV: divisior=5
s_mul_i32 s80, 0x6666, s82                         // tmp1 = dividend * magic hi
s_lshl_b64 s[80:81], s[80:81], 0x10                // left shift 16 bits
s_mul_i32 s[sgprWorkGroup1], s82, 0x6667           // tmp0 = dividend * magic lo
s_add_u32 s80, s[sgprWorkGroup1], s80              // add lo
s_addc_u32 s81, s81, 0x0                           // add hi
s_lshr_b64 s[80:81], s[80:81], 0x21                // tmp1 = (dividend * magic) << shift
s_mov_b32 s[sgprWorkGroup1], s80                   // quotient
s_mul_i32 s80, s[sgprWorkGroup1], 0x5              // quotient*divisor
s_sub_u32 s[sgprGSUSumIdx], s82, s80               // rReg = dividend - quotient*divisor
...
s_mul_hi_u32 s81, 64, s[sgprGSUSumIdx]             // gsuOffset = DepthU*bpe*GSUSumIdx
s_mul_i32 s80, 64, s[sgprGSUSumIdx]                // gsuOffset = DepthU*bpe*GSUSumIdx
...
s_mov_b32 s84, 1                                   // Init tensor size
s_mov_b32 s85, 0                                   // init tensor size
...
s_add_u32 s84, s84, s80                            // sum tensor size
s_addc_u32 s85, s85, s81                           // sum tensor size
...
s_add_u32 s84, s84, s80                            // sum tensor size
s_addc_u32 s85, s85, s81                           // sum tensor size
s_sub_u32 s[sgprShadowLimitA+0], s84, s82          // sub tileStart
s_subb_u32 s[sgprShadowLimitA+1], s85, s83         // sub tileStart
...
/* max read offset = size[n] * stride[n-1] */
s_mul_hi_u32 s83, s[sgprWorkGroup1], 32            // WorkGroup[01] * MT
s_mul_i32 s82, s[sgprWorkGroup1], 32               // WorkGroup[01] * MT
...
s_add_u32 s84, s84, s80                            // sum tensor size
s_addc_u32 s85, s85, s81                           // sum tensor size
s_sub_u32 s[sgprShadowLimitB+0], s84, s82          // sub tileStart
s_subb_u32 s[sgprShadowLimitB+1], s85, s83         // sub tileStart
...
s_mul_hi_u32 s83, s84, s[sgprStrideC1J]            // Free1
s_mul_i32 s82, s84, s[sgprStrideC1J]               // Free1
...
s_mul_hi_u32 s83, s84, s[sgprStrideCK]             // Free2
s_mul_i32 s82, s84, s[sgprStrideCK]                // Free2
...
s_cbranch_scc0 label_NoBranch_BUX004U3DA11W0GY_0   // Only branch on scc1
...
label_NoBranch_BUX004U3DA11W0GY_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read
...
/* local read inc a */
s_mov_b32 s80, 0x200                               // inc
v_add_co_u32 v[vgprLocalReadAddrA], vcc, s80, v[vgprLocalReadAddrA] // lrA += 512 (LSU*(MT+PAD)*bpe)

/* local read inc b */
s_mov_b32 s80, 0x20                                // inc
v_add_co_u32 v[vgprLocalReadAddrB], vcc, s80, v[vgprLocalReadAddrB] // lrB += 32 (LSU*bpe)
...
v_cmp_ge_i32 s[80:81], v35, s[sgprLoopCounterL]    // check K index >= Size L
...
v_cmp_lt_i32 s[80:81], v35, 4                      // set partial 0 if distance less than input per thread
...
v_lshlrev_b64 v[36:37], s82, v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0+0], v[vgprValuA_X0_I0+0+0+0+0], v36, s[80:81]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0+1], v[vgprValuA_X0_I0+0+0+0+1], v37, s[80:81]
v_lshlrev_b64 v[36:37], s82, v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+0], v[vgprValuB_X0_I0+0+0+0+0], v36, s[80:81]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+1], v[vgprValuB_X0_I0+0+0+0+1], v37, s[80:81]
s_nop 1
v_mfma_f32_16x16x16f16 acc[0:3], v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1], v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1], acc[0:3] // left value = acc[0+0:3+0]
...
label_TailLoopEndL:
label_SkipTailLoopL:
label_Summation_End_W8QJ25LWS3VXAWE7_0:
s_setprio 0                                        // optimization store
/* endSummation: add vgpr [0...32) to pool */
.set ShadowLimitB, UNDEF
.set SrdA, UNDEF
