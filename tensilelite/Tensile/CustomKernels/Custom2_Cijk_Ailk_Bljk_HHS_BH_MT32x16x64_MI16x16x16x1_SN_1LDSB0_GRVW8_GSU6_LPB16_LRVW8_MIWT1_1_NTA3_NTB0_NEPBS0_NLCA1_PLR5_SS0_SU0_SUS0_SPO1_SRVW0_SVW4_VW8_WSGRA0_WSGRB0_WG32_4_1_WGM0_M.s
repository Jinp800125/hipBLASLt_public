...
.text
.protected Custom2_Cijk_Ailk_Bljk_HHS_BH_MT32x16x64_MI16x16x16x1_SN_1LDSB0_GRVW8_GSU6_LPB16_LRVW8_MIWT1_1_NTA3_NTB0_NEPBS0_NLCA1_PLR5_SS0_SU0_SUS0_SPO1_SRVW0_SVW4_VW8_WSGRA0_WSGRB0_WG32_4_1_WGM0_M
.globl Custom2_Cijk_Ailk_Bljk_HHS_BH_MT32x16x64_MI16x16x16x1_SN_1LDSB0_GRVW8_GSU6_LPB16_LRVW8_MIWT1_1_NTA3_NTB0_NEPBS0_NLCA1_PLR5_SS0_SU0_SUS0_SPO1_SRVW0_SVW4_VW8_WSGRA0_WSGRB0_WG32_4_1_WGM0_M
.p2align 8
.type Custom2_Cijk_Ailk_Bljk_HHS_BH_MT32x16x64_MI16x16x16x1_SN_1LDSB0_GRVW8_GSU6_LPB16_LRVW8_MIWT1_1_NTA3_NTB0_NEPBS0_NLCA1_PLR5_SS0_SU0_SUS0_SPO1_SRVW0_SVW4_VW8_WSGRA0_WSGRB0_WG32_4_1_WGM0_M,@function
.section .rodata,#alloc
.p2align 6
.amdhsa_kernel Custom2_Cijk_Ailk_Bljk_HHS_BH_MT32x16x64_MI16x16x16x1_SN_1LDSB0_GRVW8_GSU6_LPB16_LRVW8_MIWT1_1_NTA3_NTB0_NEPBS0_NLCA1_PLR5_SS0_SU0_SUS0_SPO1_SRVW0_SVW4_VW8_WSGRA0_WSGRB0_WG32_4_1_WGM0_M
...
amdhsa.version:
  ...
  - 0
amdhsa.kernels:
  - .name: Custom2_Cijk_Ailk_Bljk_HHS_BH_MT32x16x64_MI16x16x16x1_SN_1LDSB0_GRVW8_GSU6_LPB16_LRVW8_MIWT1_1_NTA3_NTB0_NEPBS0_NLCA1_PLR5_SS0_SU0_SUS0_SPO1_SRVW0_SVW4_VW8_WSGRA0_WSGRB0_WG32_4_1_WGM0_M
    .symbol: 'Custom2_Cijk_Ailk_Bljk_HHS_BH_MT32x16x64_MI16x16x16x1_SN_1LDSB0_GRVW8_GSU6_LPB16_LRVW8_MIWT1_1_NTA3_NTB0_NEPBS0_NLCA1_PLR5_SS0_SU0_SUS0_SPO1_SRVW0_SVW4_VW8_WSGRA0_WSGRB0_WG32_4_1_WGM0_M.kd'
    .language:                   OpenCL C
    .language_version:
      - 2
      - 0
...
...
.end_amdgpu_metadata
Custom2_Cijk_Ailk_Bljk_HHS_BH_MT32x16x64_MI16x16x16x1_SN_1LDSB0_GRVW8_GSU6_LPB16_LRVW8_MIWT1_1_NTA3_NTB0_NEPBS0_NLCA1_PLR5_SS0_SU0_SUS0_SPO1_SRVW0_SVW4_VW8_WSGRA0_WSGRB0_WG32_4_1_WGM0_M:
...
.macro GSUSYNC labelname labelendname vgprstart
    //Victor
    ...
    s_add_u32 s[sgprSrdDd+0], s[sgprSrdD+0], 0 //s[sgprtmp0E]        // add lo GSU offset to SRD
    s_addc_u32 s[sgprSrdDd+1], s[sgprSrdD+1], 0 //s[sgprtmp1E]       // add hi GSU offset to SRD
    buffer_load_dwordx4 v[\vgprstart+4*0:\vgprstart+3+4*0], v6, s[sgprSrdDd:sgprSrdDd+3], 0 offen offset:0 // store D
    ...
    buffer_load_dwordx4 v[\vgprstart+4*1:\vgprstart+3+4*1], v6, s[sgprSrdDd:sgprSrdDd+3], 0 offen offset:0 // store D
    ...
    buffer_load_dwordx4 v[\vgprstart+4*2:\vgprstart+3+4*2], v6, s[sgprSrdDd:sgprSrdDd+3], 0 offen offset:0 // store D
    ...
    s_add_u32 s[sgprSrdDd+0], s[sgprSrdDd+0], s[sgprtmp0E]        // add lo GSU offset to SRD
    s_addc_u32 s[sgprSrdDd+1], s[sgprSrdDd+1], s[sgprtmp1E]       // add hi GSU offset to SRD
    buffer_load_dwordx4 v[\vgprstart+4*3:\vgprstart+3+4*3], v6, s[sgprSrdDd:sgprSrdDd+3], 0 offen offset:0 // store D
    ...
    s_add_u32 s[sgprSrdDd+0], s[sgprSrdDd+0], s[sgprtmp0E]        // add lo GSU offset to SRD
    s_addc_u32 s[sgprSrdDd+1], s[sgprSrdDd+1], s[sgprtmp1E]       // add hi GSU offset to SRD
    buffer_load_dwordx4 v[\vgprstart+4*4:\vgprstart+3+4*4], v6, s[sgprSrdDd:sgprSrdDd+3], 0 offen offset:0 // store D
    ...
    s_add_u32 s[sgprSrdDd+0], s[sgprSrdDd+0], s[sgprtmp0E]        // add lo GSU offset to SRD
    s_addc_u32 s[sgprSrdDd+1], s[sgprSrdDd+1], s[sgprtmp1E]       // add hi GSU offset to SRD
    buffer_load_dwordx4 v[\vgprstart+4*5:\vgprstart+3+4*5], v6, s[sgprSrdDd:sgprSrdDd+3], 0 offen offset:0 // store D
...
.macro GSUSYNC2 vgprstart
    ...
    buffer_store_dwordx2 v[\vgprstart:\vgprstart+1], v6, s[sgprSrdC:sgprSrdC+3], 0 offen offset:0 // store D
...
s_mov_b32 s61, 0x0                                 // STATIC_DIV: divisior=6
s_mul_i32 s60, 0x5555, s62                         // tmp1 = dividend * magic hi
s_lshl_b64 s[60:61], s[60:61], 0x10                // left shift 16 bits
s_mul_i32 s[sgprWorkGroup1], s62, 0x5556           // tmp0 = dividend * magic lo
...
s_mul_i32 s60, s[sgprWorkGroup1], 0x6              // quotient*divisor
...
s_cbranch_scc0 label_NoBranch_F5IGJGI1TAV7RLAE_0   // Only branch on scc1
...
label_NoBranch_F5IGJGI1TAV7RLAE_0:
s_waitcnt vmcnt(0)                                 // 8wait for global read
...
v_mul_lo_u32 v35, s59, v35                         // LSU offset: lsuoffset = sgid*(MT0+PAD)
...
v_mul_lo_u32 v35, s59, v35                         // LSU offset: lsuoffset = sgid*(MT1+PAD)
...
v_add_co_u32 v[vgprLocalReadAddrA], vcc, s59, v[vgprLocalReadAddrA] // lrA += 1024 (LSU*(MT+PAD)*bpe)
...
v_cmp_ge_i32 s[60:61], v35, s[sgprLoopCounterL]    // check K index >= Size L
...
v_cmp_lt_i32 s[60:61], v35, 4                      // set partial 0 if distance less than input per thread
...
v_lshlrev_b64 v[36:37], s62, v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0+0], v[vgprValuA_X0_I0+0+0+0+0], v36, s[60:61]
v_cndmask_b32 v[vgprValuA_X0_I0+0+0+0+1], v[vgprValuA_X0_I0+0+0+0+1], v37, s[60:61]
v_lshlrev_b64 v[36:37], s62, v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+0], v[vgprValuB_X0_I0+0+0+0+0], v36, s[60:61]
v_cndmask_b32 v[vgprValuB_X0_I0+0+0+0+1], v[vgprValuB_X0_I0+0+0+0+1], v37, s[60:61]
s_nop 1
v_mfma_f32_16x16x16f16 acc[0:3], v[vgprValuA_X0_I0+0+0+0:vgprValuA_X0_I0+0+0+0+1], v[vgprValuB_X0_I0+0+0+0:vgprValuB_X0_I0+0+0+0+1], acc[0:3] // left value = acc[0+0:3+0]
...
label_TailLoopEndL:
label_SkipTailLoopL:
label_Summation_End_IHTUDTJOALFBN5HC_0:
s_setprio 0                                        // optimization store
...
GSUSYNC label_BUSYWAIT1 label_GW_End 8
...
GSUSYNC label_BUSYWAIT1_EDGE label_GW_End 8
